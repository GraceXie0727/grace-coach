...
一个 Claude 的 Agent Skill。市面上大多数学习工具是「带你读完一本书」，可你真正想搞懂的，往往是一个**概念**——「复利」「护城河」「杠杆」——它散落在很多本书里，不属于哪一本。

grace-coach 打通书本之间的边界：给它一个概念、一本书、一个人物或一个行业，它都围绕你想懂的东西，**贴着你的需求、你的水平、你的目的，一对一给你写教材**。同一个「复利」，给创业者讲和给上班族讲不一样，给你讲的和给别人讲的也不一样。

读完随便写几句感想，它自动把你的理解和判断整理成知识卡片、存进你自己的知识库——不用记格式、不用管归档，越学越厚的是**你自己的认知资产**，不是 AI 的二手总结。

适合想认真学点东西、但总坚持不下来、笔记还散落一地的人。不需要会编程。
...
| 你想… | 对它说 | 它怎么陪你 |
|---|---|---|
| 读透一本书 | 「带我读《巴菲特致股东信》」 | 把一本书拆成连载文章带你读 |
